...
@section('content')
    ...
    <div class="modal fade" id="search" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header align-self-center">
                <h3 align="center" class="modal-title"><b>البحث عن عميل</b></h3>
            </div>
            <div class="modal-body font-weight-bold" dir="rtl">
            <form method="post" action="/customers">
                @csrf
                <div class="form-group">
                <label for="recipient-name" class="col-form-label"> العميل بالعربية / بالإنجليزية</label>
                    <input type="text" name="customer" class="form-control"><br><br>
                </div>

            </div>
            <div class="modal-footer justify-content-between" align="center" dir="rtl">
            <input type="submit" value="بحث" class="btn btn-primary">
            <a href="{{ url('/allcustomers') }}" class="btn btn-primary">إلغاء البحث</a>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-center">تعديل العميل</h5>
                </div>

                <form method="POST" action="/updateCustomer" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" id="edit_id_home" name="customer_id">
                    <div class="modal-body">
                        <div class="basic-form">
                            <div class="form-group">
                                <label  class="form-label"> العميل بالعربية</label>
                                <textarea required id="edit_home_ar" name="ar_name" class="form-control"></textarea><br><br>
                            </div>
                            <div class="form-group">
                                <label  class="form-label">العميل بالإنجليزية</label>
    ...
    <div class="modal fade" id="add">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-center">إضافة عميل</h5>
                </div>
                    ...
                    <div class="card-title">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-style1 mb-0">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">العٌملاء</a></li>
                            ...
                            <table class="table table-responsive-lg">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{--  <a href="/customer/{{ $j->id }}" class="btn btn-sm btn-info"><i class="la la-eye"></i></a>  --}}
                                            <a href="javascript:void(0);" class="btn btn-sm btn-primary" onclick="edithome({{ $j->id }})"><i class="la la-pencil"></i></a>
                                            <a onclick="destroy('destroyCustomer',{{ $j->id }})" href="javascript:void(0);" class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a>
                                        </td>
                                    </tr>
                                    @php $i++; @endphp
                                    @endforeach
